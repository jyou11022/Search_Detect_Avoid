...
hold on;
% Obstacles (circles)
% Obst_1.mid = [0.7,0.7]; Obst_1.rad = .21; % Center and radius of circle
% Obst_2.mid = [0.3,0.3]; Obst_2.rad = .21;
...
%                 line([x_new.coord(1),X_near(z).coord(1)],[x_new.coord(2),X_near(z).coord(2)],'Color', 'y', 'LineWidth', 1)
%                 drawnow;
%                 hold on;
%             end
%         end
    ...
    if CollisionFree(x_new,x_goal,Obst) && Cost(x_new,x_goal)< 4*EPS
